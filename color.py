matplot_colors = {'aliceblue': {'hex': '#F0F8FF', 'rgb': (240, 248, 255)},
                  ...
                  'lime': {'hex': '#00FF00', 'rgb': (0, 255, 0)}, 'limegreen': {'hex': '#32CD32', 'rgb': (50, 205, 50)},
                  'linen': {'hex': '#FAF0E6', 'rgb': (250, 240, 230)},
                  'magenta': {'hex': '#FF00FF', 'rgb': (255, 0, 255)}, 'maroon': {'hex': '#800000', 'rgb': (128, 0, 0)},
                  ...
                  'rebeccapurple': {'hex': '#663399', 'rgb': (102, 51, 153)},
...
def getRGB(cname):
    if cname in matplot_colors.keys():
        return matplot_colors[cname]['rgb']
    else:
        return matplot_colors['black']['rgb']


def getHEX(cname):
    if cname in matplot_colors.keys():
        return matplot_colors[cname]['hex']
    else:
        return matplot_colors['black']['hex']
